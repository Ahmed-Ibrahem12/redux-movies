...
const Movies = () => {
  const { HomeMovies, number, loading } = useSelector(
  ...
  return (
    <div>
      <div className="flex flex-col justify-center">
        <h1 className="text-[1.7em] font-bold mb-7 mt-8">Movies</h1>
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center text-black">
          {HomeMovies?.results.map((mov, i) => (
            ...
            >
              ...
              <div className="p-6">
                <p className="text-base font-bold">{mov.title}</p>
              </div>
